...
@Injectable()
export class ProcessChangePhoneOtpResponseUseCase
  implements
    UseCaseEither<OtpChangePhoneResponseDto, AuthResponseDto, UseCaseError>
{
  constructor(
  ...
  public async execute(
    request: OtpChangePhoneResponseDto
